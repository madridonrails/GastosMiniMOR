...
class User < ActiveRecord::Base
  ...
  validates_presence_of     :openid_url, :if => :openid?
  validates_uniqueness_of   :openid_url, :scope => 'account_id', :allow_nil => true
  ...
  protected
    ...
    def password_required?
      ...
      !openid? && (crypted_password.blank? || !password.nil?)      
    end
